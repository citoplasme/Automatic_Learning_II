...
class LogisticRegression:
    ...
    def optim_model_reg(self, lamda): 
        ...
        result = optimize.minimize(lambda theta: self.costFunctionReg(theta, lamda), initial_theta, method='BFGS', options={"maxiter":500, "disp":True} )
        self.theta = result.x
...
def test():
    ...
    #logmodel.optim_model() # Faster than gradient
